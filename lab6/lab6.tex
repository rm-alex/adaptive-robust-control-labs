...
\begin{itemize}
    ...
    \begin{align}
        \int\limits_{t}^{t+T}x(\tau)x^T\,d\tau>\alpha I,\ \alpha>0,T>0\label{eq:unv}
    \end{align}
...
\subsection{Выводы}
При возбуждающем воздействии в виде одной гармоники $u_1$
...
при таком входе не выполняется -- возбуждающее воздействие
недостаточно разнообразно.


При возбуждающем воздействии из нескольких гармоник $u_2$
условие неисчезающего возбуждения выполняется, ошибки
...
условия неисчезающего возбуждения ошибки
